    ...
    <div>
      ...
      <div className="relative rounded-2xl overflow-hidden max-h-[400px]">
        ...
        {loading ? (
          ...
          <div className="relative">
            ...
            />
            {/* Bottom soft shadow */}
            <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-black/15 via-black/5 to-transparent pointer-events-none" />
          </div>
        ) : null}
            ...
            {podcastData?.ptype === 'book' && (
              <>
                ...
                <p className="text-sm text-gray-500">
                  {bookDetails?.duration_display_mins} minutes
                </p>
              </>
            )}
          </>
      ...
      <div className="flex justify-between mt-6 px-4 gap-3">
        <button
          style={{
            color: '#6B0DFF',
            background:
              'radial-gradient(92.09% 394.93% at 7.91% 50%, rgba(107, 13, 255, 0.1) 0%, rgba(255, 107, 121, 0.1) 100%)',
          }}
      ...
      <div className="mt-6 px-5">
        <h3 className="font-semibold text-lg mb-2">
          {podcastData?.total_episode || 0} Chapters
        </h3>
        {loading ? (
