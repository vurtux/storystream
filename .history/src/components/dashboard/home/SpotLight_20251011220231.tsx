...
const SpotLight = ({ data }: { data: SpotlightBlock }) => {
    ...
    // Check if we have single item to prevent scroll
    ...
    return (
        <div>
            ...
            <div className={`${isSingleItem ? 'flex justify-center' : 'overflow-x-auto'}`}>
                {loading ? (
                    ...
                    <div className="flex gap-4 items-center bg-white rounded-xl shadow p-4 max-w-full">
                        <Image
