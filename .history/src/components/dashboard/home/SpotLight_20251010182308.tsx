    ...
    <div className="mb-6">
      ...
      {isSingle ? (
        <div className="flex flex-col items-center bg-white rounded-xl shadow p-4">
          <Image
            src={content.imgIrl || '/images/playListImage.png'}
            alt={content.conName}
            width={200}
            height={200}
            className="w-40 h-40 rounded-lg object-cover"
          />
          <h3 className="text-lg text-black font-semibold mt-3 text-center">{content.conName}</h3>
          <p className="text-sm text-gray-500 text-center mb-3">Apple Talk &nbsp; | &nbsp; 52:27 mins</p>
        ...
        <div className="flex gap-4 items-center bg-white rounded-xl shadow p-4">
          ...
          <div className="flex flex-col flex-1">
            <h3 className="text-lg text-black font-semibold leading-tight">{content.conName}</h3>
