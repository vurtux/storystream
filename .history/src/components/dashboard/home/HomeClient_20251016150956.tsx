...
import { remoteConGame } from "../../../lib/firebase";
...
const HomeClient = () => {
  ...
  useEffect(() => {
    ...
    fetchAndActivate(remoteCon)
      .then(() => {
        const message = getValue(remoteCon, "welcome_message").asString();
        console.log("✅ Remote Config value:", message);
