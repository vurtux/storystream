...
const HomeClient = () => {
  ...
  return (
    <div className="relative">
      <div className="sticky top-0 z-50 w-full bg-white flex py-2">
  <div className="flex items-center px-0 w-full max-w-[728px] mx-auto">
    <Image
    ...
    />
    {/* Baaki content yaha right me add kar sakte ho */}
  </div>
</div>
