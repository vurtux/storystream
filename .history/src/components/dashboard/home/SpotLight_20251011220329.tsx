...
const SpotLight = ({ data }: { data: SpotlightBlock }) => {
    ...
    const isSingleItem = data?.contents?.length === 1;
        ...
        <div className="w-full">
            ...
            {loading ? (
                <div className="w-full flex justify-center">
                    <div className="flex gap-4 items-center bg-white rounded-xl shadow p-4 animate-pulse w-full max-w-2xl">
                ...
                <div className={`w-full ${isSingleItem ? 'flex justify-center' : 'overflow-x-auto'}`}>
                    <div className={`flex gap-4 items-center bg-white rounded-xl shadow p-4 ${isSingleItem ? 'w-full max-w-2xl' : 'min-w-max'}`}>
                        <Image
