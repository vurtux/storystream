...
import { getremoteConfi } from "firebase/remote-config";
...
let remoteConfi = null;
if (typeof window !== "undefined") {
  remoteConfi = getremoteConfi(app);
  remoteConfi.settings = {
    minimumFetchIntervalMillis: 3600000,
  };
  remoteConfi.defaultConfig = {
    welcome_message: "Welcome from default config!",
  };
}

export { app, analytics, remoteConfi };
