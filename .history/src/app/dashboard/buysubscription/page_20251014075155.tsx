  ...
  return (
    ...
    >
      ...
      <div className="flex-1 w-full max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {plans.map(({ price, period }, i) => (
              <div
                ...
                cursor-pointer transition-transform hover:scale-105 hover:border-purple-500"
              >
        ...
        {/* Premium Features */}
        <div className="mt-6 p-6 pb-2 mx-auto bg-white/80 backdrop-blur-md rounded-xl shadow-sm">
      ...
      {/* Bottom CTA */}
      <div className="p-4 pt-6 sticky bottom-0 bg-white/90 backdrop-blur-md w-full text-center shadow-lg">
        <button
        ...
        <p className="text-[11px] mt-2 text-gray-700 font-medium">
